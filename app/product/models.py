...
class Product(models.Model):
    ...
    barcode = models.CharField(max_length=65, db_column='barcode', null=True)
    ...
    profit_margin = models.DecimalField(max_length=3, db_column='profit_margin', decimal_places=2, default=0.00)
